...
//    }
    ...
    // Modified part find the information of people from the Id of the lap.
    @GetMapping(path = "/Persons/laptop/{laptopId}")
    public Person getPersonByLaptopId(@PathVariable int laptopId) {
        return PersonRepository.findByLaptop_Id(laptopId);
    }
