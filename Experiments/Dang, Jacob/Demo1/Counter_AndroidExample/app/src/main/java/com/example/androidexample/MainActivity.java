...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if(extras == null)
        {
            messageText.setText("Badminton Point Tracker");
        } else
        {
            int number1 = extras.getInt("NUM");  // this will come from LoginActivity
            int  number2 = extras.getInt("NUM2");  // this will come from LoginActivity

            messageText.setText("The score is: " + number1  +" to "+ number2);
        }
